...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'footer.description': 'Premium transportation and event logistics solutions across Saudi Arabia. Making every occasion memorable with our luxury fleet and professional service.',
    ...
    'booking.success': 'Your booking details submitted successfully! A message will be provided to you soon.',
    ...
    'fleet.description': 'Browse our extensive fleet of modern, reliable vehicles for every need. Choose from Economy, SUVs, luxury cars, and buses available for daily or monthly rental.',
    ...
    'general.disclaimer': 'Images shown are for illustrative purposes only. Actual specifications, features, and details may vary.',

    // Hero Section
    'hero.title': 'Premium Transportation',
    'hero.title2': '& Event Logistics',
    'hero.subtitle': 'From luxury VIP vehicles to large-scale event logistics, we provide seamless, reliable, and premium transportation solutions that elevate every occasion.',
    ...
    'mission.text': 'To deliver seamless, high-quality transportation and logistical solutions that elevate events and experiences across Saudi Arabia, with a focus on professionalism, precision, and customer satisfaction.',
    'vision.title': 'Our Vision',
    'vision.text': 'To become the leading provider of premium transportation and event logistics services in Saudi Arabia, recognized for excellence, innovation, and unwavering commitment to exceeding customer expectations.',
    ...
    'contact.description': 'Have questions or need assistance? We\'re here to help! Reach out to us through any of the following channels.',
    'contact.contactUs': 'Contact Us',
    'contact.namePlaceholder': 'Enter your name',
    'contact.emailPlaceholder': 'Enter your email',
    'contact.messagePlaceholder': 'Enter your message',
    'contact.sendMessage': 'Send Message',
    'contact.success': 'Your details submitted successfully! A message will be provided to you soon.',
    ...
    'download.description': 'Get detailed information about our services, fleet, and company details.',
    ...
    // About Us
    'about.subtitle': 'Your trusted partner for premium transportation and event logistics',
  ...
  ar: {
    ...
    'footer.description': 'حلول النقل الفاخر ولوجستيات الفعاليات في جميع أنحاء المملكة العربية السعودية. نجعل كل مناسبة لا تُنسى بأسطولنا الفاخر وخدمتنا المهنية.',
    ...
    'booking.success': 'تم إرسال تفاصيل الحجز بنجاح! سيتم تزويدك برسالة قريبًا.',
    ...
    'fleet.description': 'تصفح أسطولنا الواسع من المركبات الحديثة والموثوقة لكل احتياج. اختر من بين الاقتصادية، ودفع رباعي، والسيارات الفاخرة، والحافلات المتاحة للإيجار اليومي أو الشهري.',
    ...
    'general.disclaimer': 'الصور المعروضة هي لأغراض توضيحية فقط. المواصفات والميزات والتفاصيل الفعلية قد تختلف.',

    // Hero Section
    'hero.title': 'النقل الفاخر',
    'hero.title2': 'ولوجستيات الفعاليات',
    'hero.subtitle': 'من مركبات VIP الفاخرة إلى لوجستيات الفعاليات واسعة النطاق، نقدم حلول نقل سلسة وموثوقة وفاخرة ترفع من مستوى كل مناسبة.',
    ...
    'mission.text': 'تقديم حلول نقل ولوجستية عالية الجودة وسلسة ترفع من مستوى الفعاليات والتجارب في جميع أنحاء المملكة العربية السعودية، مع التركيز على الاحترافية والدقة ورضا العملاء.',
    'vision.title': 'رؤيتنا',
    'vision.text': 'أن نصبح المزود الرائد لخدمات النقل الفاخر ولوجستيات الفعاليات في المملكة العربية السعودية، معترفًا بنا للتميز والابتكار والالتزام الثابت بتجاوز توقعات العملاء.',
    ...
    'contact.description': 'هل لديك أسئلة أو تحتاج إلى مساعدة؟ نحن هنا لمساعدتك! تواصل معنا من خلال أي من القنوات التالية.',
    ...
    'download.description': 'احصل على معلومات مفصلة عن خدماتنا وأسطولنا وتفاصيل الشركة.',
