...
const VehicleDetailsPage = () => {
  ...
  const [hoveredInteriorImage, setHoveredInteriorImage] = React.useState<number | null>(null);
  ...
  const getColorOptions = () => {
    ...
    if (selectedCar?.name === 'GMC Yukon' || selectedCar?.name?.includes('GMC')) {
      return [
        {
    ...
    if (selectedCar?.name === 'BMW 5 Series' || selectedCar?.name?.includes('BMW 5')) {
      return [
        {
          id: 'black',
          name: 'Black',
    ...
    if (selectedCar?.name === 'Mercedes S450' || selectedCar?.name?.includes('Mercedes S450') || selectedCar?.name?.includes('Mercedes Benz S Class')) {
      return [
        {
          id: 'black',
          name: 'Black',
    ...
    if (selectedCar?.name === 'Mercedes S450' || selectedCar?.name?.includes('Mercedes S450') || selectedCar?.name?.includes('Mercedes S Class')) {
      return [
        {
          id: 'white',
          name: 'White',
    ...
    if (selectedCar?.name === 'BMW 7 Series' || selectedCar?.name?.includes('BMW 7')) {
      return [
        {
          id: 'black',
          name: 'Black',
    ...
    if (selectedCar?.name === 'Mercedes V Class' || selectedCar?.name?.includes('Mercedes V Class') || selectedCar?.name?.includes('Mercedes V-Class')) {
      return [
        {
          id: 'black',
          name: 'Black',
    ...
    if (selectedCar?.name === 'Toyota Hiace' || selectedCar?.name?.includes('Toyota Hiace') || selectedCar?.name?.includes('Hiace')) {
      return [
        {
          id: 'black',
          name: 'Black',
    ...
    if (selectedCar?.name === 'Toyota Coaster' || selectedCar?.name?.includes('Toyota Coaster') || selectedCar?.name?.includes('Coaster')) {
      return [
        {
          id: 'default',
          name: 'Default',
    ...
    if (selectedCar?.name === 'Chinese Bus 49 Seater' || selectedCar?.name?.includes('Chinese Bus 49') || selectedCar?.name?.includes('Chines Bus 49 Sea') || selectedCar?.name?.includes('49 Seater')) {
      return [
        {
          id: 'default',
          name: 'Default',
  ...
  const colorOptions = getColorOptions();
  const currentColorImage = colorOptions[selectedColor]?.image || selectedCar?.image;
      ...
      <>
        ...
        <Box sx={{ py: 8, backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
          <Container maxWidth="lg">
            ...
            <Box sx={{ mb: 4 }}>
              <Skeleton variant="rectangular" width={200} height={40} animation="wave" sx={{ borderRadius: '8px' }} />
            </Box>
            ...
            <Grid container spacing={4}>
              ...
              <Grid size={{ xs: 12, md: 5 }}>
                <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
                  <CardContent sx={{ p: 0 }}>
                    <Skeleton variant="rectangular" height={500} animation="wave" sx={{ borderRadius: '12px' }} />
                  </CardContent>
                </Card>
              </Grid>
              ...
              <Grid size={{ xs: 12, md: 7 }}>
                <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
                  <CardContent sx={{ p: 4 }}>
                    <Skeleton variant="text" width="60%" height={50} animation="wave" sx={{ mb: 4 }} />
                    
                    <Grid container spacing={3} sx={{ mb: 4 }}>
                      <Grid size={{ xs: 6 }}>
                        <Skeleton variant="text" width="40%" height={20} animation="wave" sx={{ mb: 1 }} />
                        <Skeleton variant="text" width="60%" height={30} animation="wave" sx={{ mb: 3 }} />
                        <Skeleton variant="text" width="40%" height={20} animation="wave" sx={{ mb: 1 }} />
                      ...
                      <Grid size={{ xs: 6 }}>
                        ...
                        <Skeleton variant="text" width="60%" height={30} animation="wave" sx={{ mb: 3 }} />
                        <Skeleton variant="text" width="40%" height={20} animation="wave" sx={{ mb: 1 }} />
                        <Skeleton variant="text" width="50%" height={30} animation="wave" sx={{ mb: 3 }} />
                        <Skeleton variant="text" width="40%" height={20} animation="wave" sx={{ mb: 1 }} />
                        <Skeleton variant="text" width="50%" height={30} animation="wave" />
                      </Grid>
                    </Grid>
      ...
      <Box sx={{ py: 8, backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
        <Container maxWidth="lg">
          ...
          <Grid container spacing={4}>
            ...
            <Grid size={{ xs: 12, md: 5 }}>
              <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
                <CardContent sx={{ p: 3 }}>
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        width: '100%',
                        height: '100%',
                        transform: hoveredMainImage ? 'scale(1.15)' : 'scale(1)',
                  ...
                  {/* Color Swatches */}
                  {(selectedCar?.name === 'Ford Taurus' || selectedCar?.name === 'GMC Yukon' || selectedCar?.name?.includes('GMC') || selectedCar?.name === 'BMW 5 Series' || selectedCar?.name?.includes('BMW 5') || selectedCar?.name === 'BMW 7 Series' || selectedCar?.name?.includes('BMW 7') || selectedCar?.name === 'Mercedes S450' || selectedCar?.name?.includes('Mercedes S450') || selectedCar?.name?.includes('Mercedes S Class') || selectedCar?.name === 'Mercedes V Class' || selectedCar?.name?.includes('Mercedes V Class') || selectedCar?.name?.includes('Mercedes V-Class') || selectedCar?.name === 'Toyota Hiace' || selectedCar?.name?.includes('Toyota Hiace') || selectedCar?.name?.includes('Hiace') || selectedCar?.name === 'Toyota Coaster' || selectedCar?.name?.includes('Toyota Coaster') || selectedCar?.name?.includes('Coaster') || selectedCar?.name === 'Chinese Bus 49 Seater' || selectedCar?.name?.includes('Chinese Bus 49') || selectedCar?.name?.includes('Chines Bus 49 Sea') || selectedCar?.name?.includes('49 Seater')) && colorOptions.length > 1 && (
                    <Box>
                      <Typography
                        variant="body2"
                        sx={{
            ...
            <Grid size={{ xs: 12, md: 7 }}>
              <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', height: '100%' }}>
                ...
                <Grid size={{ xs: 12, md: 4 }}>
                  <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', height: '100%' }}>
                    <CardContent sx={{ p: 3 }}>
                      ...
                      <Box sx={{ mb: 2 }}>
                        <Typography variant="caption" sx={{ color: '#757575', fontSize: '0.75rem', fontWeight: 500, textTransform: 'uppercase' }}>
                          Engine
                        </Typography>
          ...
          {(selectedCar?.name === 'GMC Yukon' || selectedCar?.name?.includes('GMC')) && (
            <Box sx={{ mt: 6 }}>
              <Typography
                variant="h4"
                component="h2"
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', height: '100%' }}>
                    <CardContent sx={{ p: 3 }}>
                      ...
                      <Box sx={{ mb: 2 }}>
                        <Typography variant="body2" sx={{ color: '#1a1a1a', mb: 1.5, display: 'flex', alignItems: 'flex-start' }}>
                          <Box component="span" sx={{ color: '#52A4C1', mr: 1, fontWeight: 'bold' }}>•</Box>
                          <Box component="span">Super Cruise hands-free driver assistance technology* with 3-year OnStar® One plan*</Box>
                        </Typography>
                        <Typography variant="body2" sx={{ color: '#1a1a1a', mb: 1.5, display: 'flex', alignItems: 'flex-start' }}>
                          <Box component="span" sx={{ color: '#52A4C1', mr: 1, fontWeight: 'bold' }}>•</Box>
                          <Box component="span">Air Ride Adaptive Suspension</Box>
                        </Typography>
                        <Typography variant="body2" sx={{ color: '#1a1a1a', mb: 1.5, display: 'flex', alignItems: 'flex-start' }}>
                          <Box component="span" sx={{ color: '#52A4C1', mr: 1, fontWeight: 'bold' }}>•</Box>
                          <Box component="span">24" selective machined and painted After Midnight Metallic aluminum wheels</Box>
                        </Typography>
                        <Typography variant="body2" sx={{ color: '#1a1a1a', mb: 1.5, display: 'flex', alignItems: 'flex-start' }}>
                          <Box component="span" sx={{ color: '#52A4C1', mr: 1, fontWeight: 'bold' }}>•</Box>
                          <Box component="span">16-way power front seats with massage feature</Box>
                        </Typography>
                        <Typography variant="body2" sx={{ color: '#1a1a1a', display: 'flex', alignItems: 'flex-start' }}>
                          <Box component="span" sx={{ color: '#52A4C1', mr: 1, fontWeight: 'bold' }}>•</Box>
                          <Box component="span">Bose* 18-speaker sound system</Box>
                        </Typography>
                      </Box>
                    </CardContent>
                  </Card>
                  ...
                  <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', height: '100%' }}>
                    <CardContent sx={{ p: 3 }}>
                      ...
                      <Box sx={{ mb: 2 }}>
                        ...
                        <Typography variant="body2" sx={{ color: '#1a1a1a', display: 'flex', alignItems: 'flex-start' }}>
                          <Box component="span" sx={{ color: '#52A4C1', mr: 1, fontWeight: 'bold' }}>•</Box>
                          <Box component="span">Second-row heated and ventilated executive seating* with massage feature and Bose* head-restraint speakers</Box>
                        </Typography>
                      </Box>
                      <Typography
                        variant="caption"
          ...
          {(selectedCar?.name === 'BMW 5 Series' || selectedCar?.name?.includes('BMW 5')) && (
            <Box sx={{ mt: 6 }}>
              <Typography
                variant="h4"
                component="h2"
          ...
          {(selectedCar?.name === 'Mercedes S450' || selectedCar?.name?.includes('Mercedes S450') || selectedCar?.name?.includes('Mercedes S Class')) && (
            <Box sx={{ mt: 6 }}>
              <Typography
                variant="h4"
                component="h2"
          ...
          {(selectedCar?.name === 'BMW 7 Series' || selectedCar?.name?.includes('BMW 7')) && (
            <Box sx={{ mt: 6 }}>
              <Typography
                variant="h4"
                component="h2"
          ...
          {(selectedCar?.name === 'Mercedes V Class' || selectedCar?.name?.includes('Mercedes V Class') || selectedCar?.name?.includes('Mercedes V-Class')) && (
            <Box sx={{ mt: 6 }}>
              <Typography
                variant="h4"
                component="h2"
          ...
          {(selectedCar?.name === 'Toyota Hiace' || selectedCar?.name?.includes('Toyota Hiace') || selectedCar?.name?.includes('Hiace')) && (
            <Box sx={{ mt: 6 }}>
              <Typography
                variant="h4"
                component="h2"
          ...
          {(selectedCar?.name === 'Toyota Hiace' || selectedCar?.name?.includes('Toyota Hiace') || selectedCar?.name?.includes('Hiace')) && (
            <Box sx={{ mt: 6 }}>
              ...
              <Grid container spacing={3}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', overflow: 'hidden' }}>
                    <Box 
                      sx={{ 
                        position: 'relative', 
                        width: '100%', 
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 0 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    <CardContent sx={{ p: 2 }}>
                      <Typography variant="body2" sx={{ fontWeight: 600, color: '#1a1a1a', textAlign: 'center' }}>
                        Interior Design
                      </Typography>
                    </CardContent>
                  </Card>
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 1 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 2 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 3 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 4 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 5 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 6 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 7 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 8 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
          ...
          {(selectedCar?.name === 'Toyota Coaster' || selectedCar?.name?.includes('Toyota Coaster') || selectedCar?.name?.includes('Coaster')) && (
            <Box sx={{ mt: 6 }}>
              <Typography
                variant="h4"
                component="h2"
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 9 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', overflow: 'hidden' }}>
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 10 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    <CardContent sx={{ p: 2 }}>
                      ...
                      <Typography variant="caption" sx={{ color: '#757575', textAlign: 'center', display: 'block', mt: 0.5 }}>
                        Seats up to 30 people comfortably with high roof and wide body
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', overflow: 'hidden' }}>
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 11 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    <CardContent sx={{ p: 2 }}>
                      ...
                      <Typography variant="caption" sx={{ color: '#757575', textAlign: 'center', display: 'block', mt: 0.5 }}>
                        Large, comfortable seats with individual adjustable air-conditioning vents
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', overflow: 'hidden' }}>
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 12 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    <CardContent sx={{ p: 2 }}>
                      ...
                      <Typography variant="caption" sx={{ color: '#757575', textAlign: 'center', display: 'block', mt: 0.5 }}>
                        Deep and large doorstep allows passengers to board more easily and safely
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Card sx={{ borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', overflow: 'hidden' }}>
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          width: '100%',
                          height: '100%',
                          transform: hoveredInteriorImage === 13 ? 'scale(1.15)' : 'scale(1)',
                          transition: 'transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                          willChange: 'transform',
                        }}
                      >
                    ...
                    <CardContent sx={{ p: 2 }}>
                      ...
                      <Typography variant="caption" sx={{ color: '#757575', textAlign: 'center', display: 'block', mt: 0.5 }}>
                        Power steering and five-speed manual transmission for easy and comfortable driving
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
          ...
          {(selectedCar?.name === 'Chinese Bus 49 Seater' || selectedCar?.name?.includes('Chinese Bus 49') || selectedCar?.name?.includes('Chines Bus 49 Sea') || selectedCar?.name?.includes('49 Seater')) && (
            <Box sx={{ mt: 6 }}>
              <Typography
                variant="h4"
                component="h2"
