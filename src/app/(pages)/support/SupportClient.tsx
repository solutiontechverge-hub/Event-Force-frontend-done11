...
import {
  ...
  type SupportItemIcon,
} from './data';

const supportItemIcons: Record<SupportItemIcon, React.ReactElement> = {
  Help: <Help />,
...
const quickActionIcons: Record<QuickActionIcon, React.ReactElement> = {
                    ...
                    >
                      {quickActions.map((action, index) => {
                        const commonProps = {
                          ...
                          startIcon: quickActionIcons[action.icon],
                          sx: {
