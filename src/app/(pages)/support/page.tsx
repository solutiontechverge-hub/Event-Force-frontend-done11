      ...
      <>
        ...
        <Box sx={{ py: 8, backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
          <Container maxWidth="lg">
            <Skeleton variant="text" width="40%" height={50} animation="wave" sx={{ mx: 'auto', mb: 6, textAlign: 'center' }} />
            <Grid container spacing={4}>
                      ...
                      <React.Fragment key={item}>
                        <Box sx={{ p: 3 }}>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                            ...
                            <Box sx={{ flex: 1 }}>
                              <Skeleton variant="text" width="60%" height={30} animation="wave" sx={{ mb: 1 }} />
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  <Card sx={{ p: 3 }}>
                    <Skeleton variant="text" width="50%" height={30} animation="wave" sx={{ mb: 2 }} />
                    <Skeleton variant="rectangular" height={100} animation="wave" sx={{ borderRadius: '8px', mb: 2 }} />
                  ...
                  <Card sx={{ p: 3 }}>
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                      {[1, 2, 3, 4, 5].map((item) => (
                        <Skeleton key={item} variant="rectangular" width={100} height={32} animation="wave" sx={{ borderRadius: '16px' }} />
                      ))}
                    </Box>
                  </Card>
                </Box>
                        ...
                        if (action.type === 'whatsapp') {
                          return (
                            <Button
                              ...
                              {...commonProps}
                              onClick={() => {
                                const phoneNumber = '966125786869'; // +966125786869
