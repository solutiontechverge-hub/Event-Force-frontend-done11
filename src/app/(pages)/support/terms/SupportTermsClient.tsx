...
import {
  ...
  termsHeroSubtitle,
  termsSupportIntro,
  termsSupportSections,
} from '@/data/legal/terms';

const SupportTermsClient = () => {
      ...
      <Box sx={{ py: 8 }}>
        <Container maxWidth="lg">
          <Card sx={{ p: 4 }}>
            ...
            {termsSupportSections.map((section, index) => (
              <Box key={index} sx={{ mb: 4 }}>
                ...
                {index < termsSupportSections.length - 1 && (
                  <Divider sx={{ my: 3 }} />
                )}
              </Box>
            ))}
...
export default SupportTermsClient;
