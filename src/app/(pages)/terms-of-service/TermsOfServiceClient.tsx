...
const sectionIcons: Record<TermsSectionIcon, React.ReactElement> = {
  Gavel: <Gavel />,
  CarRental: <CarRental />,
  Security: <Security />,
      ...
      <Box sx={{ py: 8 }}>
        <Container maxWidth="lg">
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            {termsMainSections.map((section, index) => (
              <ScaleInView
                key={index}
                initialScale={0.9}
                duration={0.8}
      ...
      <Box sx={{ py: 8, backgroundColor: '#f8f9fa' }}>
        <Container maxWidth="lg">
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            {termsAdditionalSections.map((term, index) => (
              <ScaleInView
                key={index}
                initialScale={0.9}
                duration={0.8}
            ...
            <SlideUpInView initialY={40} duration={1.0} delay={0.4}>
              ...
              >
                <Typography variant="body1" sx={{ color: '#333', fontWeight: 'bold' }}>
                  Email: {termsContactEmail}
                </Typography>
                <Typography variant="body1" sx={{ color: '#333', fontWeight: 'bold' }}>
                  Phone: {termsContactPhone}
                </Typography>
              </Box>
            </SlideUpInView>
          </Box>
